...
<div class="center_title_bar"><?php print $lang["sale"]["update"]; ?></div>
            ...
            <div class="contact_form">
                <form action="index.php" name="insertSale" method="post" accept-charset="utf-8">
                    ...
                    <div class="form_row">
                        ...
                        <input type="text" name="price" class="contact_input" value="<?php print $sale->price; ?>" />
                    </div>

                    <div class="form_row">
                        <label class="contact"><strong><?php print $lang["sale"]["stock"]; ?></strong></label>
                        <input type="text" name="stock" class="contact_input" value="<?php print $sale->stock; ?>" />
                    </div>
